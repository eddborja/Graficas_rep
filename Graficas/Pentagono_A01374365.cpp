...
void Initializa()
{
	...
	positions.push_back(glm::vec2 (0.5*cos(glm::radians(306.00)), .5*sin(glm::radians(306.00)) ));
	positions.push_back(glm::vec2(1.0*cos(glm::radians(306.00)), 1.0*sin(glm::radians(306.00))));
	positions.push_back(glm::vec2(1.0 * cos(glm::radians(18.00)), 1.0 * sin(glm::radians(18.00))));

	positions.push_back(glm::vec2(0.5*cos(glm::radians(18.00)), .5*sin(glm::radians(18.00))));
	positions.push_back(glm::vec2(.5 * cos(glm::radians(90.00)), .5 * sin(glm::radians(90.00))));

	positions.push_back(glm::vec2(1.0 * cos(glm::radians(90.00)), 1.0 * sin(glm::radians(90.00))));
	positions.push_back(glm::vec2(.5 * cos(glm::radians(162.00)), .5* sin(glm::radians(162.00))));
	positions.push_back(glm::vec2(1.0 * cos(glm::radians(162.00)), 1.0 * sin(glm::radians(162.00))));
	positions.push_back(glm::vec2(.5* cos(glm::radians(234.00)), .5 * sin(glm::radians(234.00))));
	positions.push_back(glm::vec2(1.0 * cos(glm::radians(234.00)), 1.0 * sin(glm::radians(234.00))));
	positions.push_back(glm::vec2(.5 * cos(glm::radians(306.00)), .5 * sin(glm::radians(306.00))));
	positions.push_back(glm::vec2(1.0 * cos(glm::radians(306.00)), 1.0 * sin(glm::radians(306.00))));
